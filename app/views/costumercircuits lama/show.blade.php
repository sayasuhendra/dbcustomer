...
<div class="row">
  {{ link_to_route('costumercircuits.index', 'Daftar Semua Customer Circuit', null, ['class' => 'btn btn-default']) }}
  <input type="button" value="Kembali ke Halaman Sebelumnya" onclick="history.back(-1)" class="btn btn-default pull-right"/>
...
{{ Form::model($costumercircuit->adsls, array('method' => 'PATCH', 'route' => array('adsls.update', $costumercircuit->adsls->id), 'data-remote', 'data-remote-success-message' => 'ADSL sudah di edit')) }}
  <div class="modal fade" id="EditADSL" tabindex="-2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          <h4 class="modal-title" id="myModalLabel">Tambah Perangkat Baru</h4>
              ...
              <div class="form-horizontal">
                ...
                <div class="form-group">
                    {{ Form::label('nomer', 'Nomer ADSL :', ['class' => 'col-sm-3']) }}
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    {{ Form::label('tumpangan', 'Nomer Tumpangan :', ['class' => 'col-sm-3']) }}
                    <div class="col-sm-9">
...
<!-- Modal Edit ADSL End -->
                ...
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    <h3 class="panel-title pull-left">Data ADSL</h3>
                    <div class="btn-group pull-right">
                    <button class="btn btn-warning btn-xs" data-toggle="modal" data-target="#EditADSL"><i class="glyphicon glyphicon-pencil"></i></button>
                    {{ Form::open(array('data-remote', 'method' => 'DELETE', 'route' => array('adsls.destroy', $costumercircuit->adsls->id), 'style'=>'display:inline-block')) }}
