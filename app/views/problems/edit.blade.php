        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        {{ Form::input('datetime', 'start', null, ['class' => 'form-control input-group date form_datetime', 'id' => 'start']) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        {{ Form::input('datetime', 'finish', null, ['class' => 'form-control input-group date form_datetime', 'id' => 'finish']) }}
                    </div>
                </div>
